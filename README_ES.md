...
> *Todas las pruebas fueron ejecutadas con 1,000 conexiones en paralelo y 0% de discrepancia de datos/hashes.*
...
*(Los binarios precompilados se instalan automáticamente para Linux, macOS y Windows)*
...
Ejecutar benchmarks de hardware integrados:

```python
report = b4n1_boost.run_benchmarks(iterations=100000)
print(f"Operaciones/seg: {report['ops_per_sec']:,}")
```
...
Licenciado bajo **Business Source License 1.1 (BSL 1.1)** / Principios de Código Abierto.
